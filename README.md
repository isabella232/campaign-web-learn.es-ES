...
1. Clic **Sugerir una edición** y enviar una solicitud de extracción (PR) con los cambios en la interfaz de usuario de GitHub.
   ...
   Para obtener más información, consulte la [Guía general del colaborador de Adobe Docs](https://experienceleague.adobe.com/docs/contributor/contributor-guide/introduction.html?lang=es).
